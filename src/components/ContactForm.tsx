...
export default function ContactForm() {
  const formSchema = z.object({
      ...
      message: z.string()
        ...
        .max(1000, {message: "Try to keep the message within 1000 characters."}),
  })
  ...
  return (
    <section className="w-3/5 mx-auto py-16">
      <h1 className="text-3xl font-bold pb-12 text-center">If you have any questions about the course, feel free to ask!</h1>
